...
\x1b[1;92m Owner  : @KaitoDev 

\x1b[1;92m Github : https://github.com/hyacinth-educ

\x1b[1;92m Facebok: m.me/rootlocalhost.remake 
...
def menu():
    ...
    if sel in['1', '01']:
        ...
        os.system('xdg-open https://www.facebook.com/rootlocalhost.remake')
...
class create:
    ...
    def start(self):
        ...
        for x in range(lim):
            ...
            sys.stdout.write(f'\r {OO}[+] : [KAITODEV]{OO}{self.loop}/{str(lim)} OK:{len(ok)} - CP:{len(cp)}{OO} '),
